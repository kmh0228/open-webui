<script lang="ts">
	...
	import { blobToFile, createMessagesList, findWordIndices } from './utils';
	import { transcribeAudio } from '$lib/apis/audio';
	import { uploadFile } from '$lib/apis/files';
	import { getTools } from '$lib/apis/tools';

	import { WEBUI_BASE_URL, WEBUI_API_BASE_URL, PASTED_TEXT_CHARACTER_LIMIT } from './constants';
												...
												on:keydown={async (e) => {
													...
													if (commandsContainerElement) {
														...
														if (
															...
															// 防止 Enter 键创建新行
															// 使用 keyCode '13' 作为 Enter 键，以支持中文/日文键盘
									...
									{:else}
										<textarea
											...
											on:keydown={async (e) => {
												...
												// Command/Ctrl + Shift + Enter 提交消息对
												if (isCtrlPressed && e.key === 'Enter' && e.shiftKey) {
													e.preventDefault();
													createMessagePair(prompt);
												}
