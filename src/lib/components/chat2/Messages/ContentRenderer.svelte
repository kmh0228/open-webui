<script>
	...
	import { chatId, mobile, showArtifacts, showControls, showOverview } from './stores';
	import ChatBubble from './icons/ChatBubble.svelte';
	import { stringify } from 'postcss';
	import CustomRenderer from './CustomRender/CustomRender.svelte';
	...
	// 是否使用自定义的组件
	export let useCustomRenderer = false;
...
<div bind:this={contentContainerElement}>
	{#if useCustomRenderer}
		<!-- <CustomRenderer {id} {content} {model} {save} {sourceIds} {onSourceClick} on:update on:code /> -->
